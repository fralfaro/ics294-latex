...
\title{\textbf{Trabajo de Econometría}\\\large ICS-294}
...
Las bases de datos \textbf{no se pueden repetir entre grupos}. Por ello, cada grupo debe anotar a sus integrantes en la planilla compartida \href{https://docs.google.com/spreadsheets/d/1NI2CzwLY366fZft4j1RXH3JG4dCJMYc58QUd5BpT75A/edit?usp=sharing}{Grupos Econometría 2026-I}, en la columna correspondiente a la base de datos elegida.
...
\begin{itemize}
    \item \textbf{Avance preliminar}
    
    Se debe entregar un documento inicial en \texttt{Google Colab} que incluya:
    \begin{itemize}
    ...
    \item \textbf{Informe final}

    Se debe entregar un informe en formato PDF, acompañado de los códigos en \texttt{R} que permitan replicar los resultados. El código debe incluir explicaciones breves de los comandos utilizados.
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Test de las hipótesis de investigación.
        \end{itemize}
