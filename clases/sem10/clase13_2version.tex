...
\title[ICS-162]{Econometría ICS-294\\ \small{Clase 13: Propiedades asintóticas  }}
...
\begin{figure}
        \centering
        \includegraphics[width=0.7\linewidth]{sem10/Graficos Betas.png}
    \end{figure}
...
\begin{figure}
        \centering
        \includegraphics[width=1\linewidth]{sem10/codigoRconsistencia.png}
    \end{figure}
\end{frame}
