...
Las bases de datos NO se pueden repetir entre grupos, por ello deben anotar a los integrantes de su grupo en la planilla compartida \href{https://docs.google.com/spreadsheets/d/1NI2CzwLY366fZft4j1RXH3JG4dCJMYc58QUd5BpT75A/edit?usp=sharing}{Grupos Econometría 2026-I} en la columna de la base de datos elegida.
...
\begin{itemize}
    ...
    Se debe entregar un informe en formato PDF, acompañado de  los códigos en \texttt{R} que permitan replicar los resultados (incluyendo explicaciones breves de los comandos utilizados).
    ...
    \item \textbf{Presentación oral (10\%)}
