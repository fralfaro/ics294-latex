...
\lhead{\includegraphics[scale=0.11]{programa/logoUSM.png}} % texto izquierda de la cabecera
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\linewidth]{complemetario//Imagenes/normal.png}
\end{figure}
\end{document}