...
\title[ICS-162]{Econometría ICS-294\\ \small{Clase 12: Inferencia sobre un conjunto de parámetros}}
...
\begin{frame}[t]{Test de hipótesis y modelo restringido}
    ...
    \newline → Mirar las diferencias entre el SSR de un modelo que las incluye (modelo
...
\begin{frame}{Zona de rechazo}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\linewidth]{sem9/images/zona.png}
    \end{figure}        
...
\begin{frame}{Distribución F}
    \begin{figure}
        \centering
        \includegraphics[width=0.7\linewidth]{sem9/images/distr_F.png}
    \end{figure}
\end{frame}
...
\begin{frame}[shrink=10]{Ejemplo: rendimiento y salario en el baseball}
    \begin{itemize}
        ...
        $}
             ...
             \begin{figure}
        \centering
        \includegraphics[width=0.8\linewidth]{sem9/images/nrsalary.png}
    \end{figure}
        ...
        $}
             \begin{figure}
        \centering
        \includegraphics[width=0.8\linewidth]{sem9/images/rsal.png}
    \end{figure}    
    \end{itemize}
\end{frame}
...
\begin{frame}{Ejemplo: rendimiento y salario en el baseball}
             \begin{figure}
        \centering
        \includegraphics[width=0.8\linewidth]{sem9/images/bsbl.png}
    \end{figure}
